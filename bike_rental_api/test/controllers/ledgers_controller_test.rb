...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { bike_id: @ledger.bike_id, location_id: @ledger.location_id } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { bike_id: @ledger.bike_id, location_id: @ledger.location_id } }, as: :json
    assert_response 200
  end
